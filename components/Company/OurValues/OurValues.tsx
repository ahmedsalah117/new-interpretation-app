...
const OurValues = () => {
  const OurValuesCards = [
    {
      ...
      cardText:
        "We believe language services should be available to all, regardless of location or budget.",
    ...
    },
    {
      ...
      cardText:
        "We strive for the highest quality in every interaction, maintaining strict standards for our interpreters, with 2 dedicated teams of Quality Control and Quality Assurance.",
    ...
    },
    {
      ...
      cardText:
        "We understand that communication needs can be urgent, so we provide swift, reliable service.",
  ...
  return (
    <Box className="our-values-section" pb={20}>
      <Stack className="section-container" alignItems={"center"} spacing={8}>
        ...
        >
          ...
          >
            Our core principles guide every decision we make and every service
            we provide
          </Typography>
        </Stack>
