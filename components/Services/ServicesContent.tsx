...
const ServicesContent = () => {
  ...
  return (
    <Stack className="section-container">
      <Stack className="section-content" id="services-page-expertise-section" spacing={'100px'}>
        <Stack
          pt="100px"
          maxWidth="1200px"
        ...
        <Stack direction={{ xs: 'column', lg: 'row' }} spacing={3} width="100%" className="solutions-section-wrapper" alignItems="center">
          <Stack spacing={3} maxWidth="794px" width="100%" alignItems={{ xs: 'center', lg: 'flex-start' }}>
            <Stack
              maxWidth={{ xs: '383px', lg: '792px' }}
              width="100%"
              direction={{ xs: 'column', lg: 'row' }}
              sx={{ padding: '24px', border: '1px solid #DFE6F0', borderRadius: '20px', backgroundColor: 'white' }}
              spacing={2}
            >
              <Stack maxWidth="360px" sx={{ borderRadius: '20px', overflow: 'hidden' }} width="100%" alignItems="center">
                <Image
              ...
              <Stack maxWidth="364px" width="100%" spacing="30px" textAlign="left">
                <Typography fontSize="24px" fontWeight={700} lineHeight="50px" width="100%">
                  {translate('services:startup:title')}
                </Typography>

                <Typography fontSize="16px" fontWeight={400} lineHeight="30px" width="100%">
            ...
            >
              ...
              <Stack maxWidth="364px" width="100%" spacing="30px">
                <Typography fontSize={{ xs: '16px', lg: '24px' }} fontWeight={700} lineHeight="50px" width="100%">
          ...
          <Stack
            ...
            width="100%"
            direction="column"
            sx={{ paddingX: '24px', paddingY: '32px', border: '1px solid #DFE6F0', borderRadius: '20px', backgroundColor: 'white' }}
            spacing={2}
          >
            <Stack maxWidth="335px" sx={{ borderRadius: '20px', overflow: 'hidden' }} alignItems="center" width="100%">
              <Image
            ...
            <Stack maxWidth="345px" width="100%" spacing="30px">
              <Typography fontSize="24px" fontWeight={700} lineHeight="50px" maxWidth="330px" width="100%">
        ...
        >
          ...
          {SERVICES_CARDS.map((card) => (
            <Stack maxWidth="340px" width="100%" direction="row" alignItems="flex-start" spacing="20px">
              <Image src={card.icon} alt={'icon'} width="70" height="64" />
              <Stack spacing={2}>
                <Typography fontSize="20px" fontWeight={600} lineHeight="24px" color="#232932">
                  {card.title}
                </Typography>
                <Typography fontSize="14px" fontWeight={400} lineHeight="24px" color="#232932">
                  {card.text}
                </Typography>
              </Stack>
            </Stack>
